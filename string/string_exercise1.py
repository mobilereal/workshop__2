# จงเขียนคำสั่งเพื่อแสดงความยาวของตัวอักษร
...
# จงเขียนคำสั่งเพื่อแสดงอักษรแรกของข้อความ
#  "Python is one of the fastest-growing programming languages"
string = "Python is one of the fastest-growing programming languages"

print(string[0])

# จงเขียนคำสั่งเพื่อแสดง
# "fastest" ของข้อความ "Python is one of the fastest-growing programming languages"
string = "Python is one of the fastest-growing programming languages"
print(string[21:28])
...
# จงเขียนคำสั่งเพื่อแสดข้อความ
# "Python is one of the fastest-growing programming languages" ให้เป็นตัวพิมเล็กทั้งหมด
string = "Python is one of the fastest-growing programming languages"

print(string.lower())

# จงเขียนคำสั่งเพื่อแสดข้อความ
# "Python is one of the fastest-growing programming languages" ที่ถูกแทนที่อักษร r ด้วย x ทั้งหมด
string = "Python is one of the fastest-growing programming languages"
